...
<body style="overflow-x: hidden">
    ...
    <div id="content_page" style="width: 100%;">
        <header class="header">
            <nav id="nav">
                <ul class="main-menu">
                    <li><img src="https://cdn2.steamgriddb.com/icon/602d1305678a8d5fdb372271e980da6a/32/256x256.png" alt="아이콘"></li>
...
.main-menu > li:hover {
    text-shadow:0px 0px 20px #009CFF;
}
